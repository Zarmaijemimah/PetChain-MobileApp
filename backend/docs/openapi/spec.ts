/**
 * PetChain API — OpenAPI 3.0 Specification
 *
...
\`\`\`
    `.trim(),
    contact: {
      name: 'PetChain Engineering',
      email: 'engineering@petchain.app',
  ...
  servers: [
    ...
    {
      url: 'https://staging.petchain.app/api',
      description: 'Staging environment',
    },
    {
      url: 'https://api.petchain.app/api',
