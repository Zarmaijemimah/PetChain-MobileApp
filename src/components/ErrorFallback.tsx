...
export default function ErrorFallback({ onRetry, onContactSupport, onRestart, onClearCache }: Props) {
  const contactSupport = () => {
    if (onContactSupport) return onContactSupport();
    const mailto = 'mailto:support@petchain.app?subject=App%20Error&body=I%20encountered%20an%20error.';
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.message}>An unexpected error occurred. Try retrying or contact support.</Text>
      <View style={styles.actions}>
        <TouchableOpacity style={styles.btn} onPress={onRetry} accessibilityRole="button">
          <Text style={styles.btnText}>Retry</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.btn, styles.secondary]} onPress={contactSupport} accessibilityRole="button">
          <Text style={[styles.btnText, styles.secondaryText]}>Contact Support</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.actions}>
        <TouchableOpacity style={[styles.btn, styles.alt]} onPress={clearCache} accessibilityRole="button">
          <Text style={styles.btnText}>Clear Cache</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.btn, styles.alt]} onPress={restart} accessibilityRole="button">
