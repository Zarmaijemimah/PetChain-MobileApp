...
router.post('/', authorizeRoles(UserRole.ADMIN, UserRole.VET), async (req: AuthenticatedRequest, res) => {
...
router.get('/:id/share', authorizeRoles(UserRole.ADMIN, UserRole.VET), async (req: AuthenticatedRequest, res) => {
